    ...
    <div class="card-body">
        <div class="card ctcard">
            <div class="card-header card-header-warning">
                <center>
                    <h3><i class="icon icon-bullhorn"></i> Adicionar Novo Usuário</h3>
                </center>
            </div>
            <div class="card-body">
                <form>
            ...
            <div class="card-body">
                <form method="post">
                    ...
                    <div class="form-group ctinput">
                        <label class="form-label">Proteger esta lista de reprodução</label>
                    ...
                    <div class="form-group ctinput">
                        ...
                        <input class="form-control" id="title" name="title" placeholder="Nome do Servidor" type="text"
                            required />
                    </div>
                    <div class="form-group ctinput">
                        <label class="form-label" for="url">DNS</label>
                        <input class="form-control" id="url" name="url" placeholder="Digite o DNS" type="text" id="url"
                            required />
                    </div>
                    <div class="form-group ctinput">
                        <label class="form-label" for="username">Nome de Usuário</label>
                        <input class="form-control" id="username" name="username" placeholder="Digite o Nome de Usuário"
                            type="text" id="username" required />
                    </div>
                    <div class="form-group ctinput">
                        <label class="form-label" for="password">Senha</label>
                        <input class="form-control" id="password" name="password" placeholder="Digite a Senha"
