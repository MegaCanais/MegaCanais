<?php
include(__DIR__ . '/database.php');//parse config options
...
class SQLiteWrapper {
	...
	public function selectWithCount($tableName, $countColumn, $where = "", $placeholders = array()) {
	...
	public function findDuplicates($tableName, $column) {
